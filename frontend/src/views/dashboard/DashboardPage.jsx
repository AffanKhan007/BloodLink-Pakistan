    ...
    <motion.div className="page-stack" {...motionProps}>
      ...
      {hasDonorProfile ? (
        <motion.section className="content-card" {...itemProps}>
          <SectionIntro
            ...
            actions={
              <Link className="button button-primary" href="/donor/matches">View my matches</Link>
            }
          />
        ...
        <motion.section className="content-card" {...itemProps}>
          <SectionIntro
            ...
            actions={
              <Link className="button button-primary" href="/donor/profile">Create donor profile</Link>
            }
          />
        </motion.section>
      )}
      ...
      <motion.section className="content-card" {...itemProps}>
        <SectionIntro
          ...
          actions={
            <Link className="button button-primary" href="/blood-radar">
              <Radar size={14} />
              Open Blood Radar
            </Link>
          }
      ...
      <motion.section className="content-card" {...itemProps}>
        <SectionIntro
          ...
          actions={
            <>
              <Link className="button button-secondary" href="/receiver/create-request">New request</Link>
              <Link className="button button-primary" href="/receiver/requests">View all</Link>
            </>
          }
        />
        {requestCount === 0 ? (
