    ...
    <div className="page-stack">
      <section className="content-card">
        <SectionIntro
          ...
          actions={
            <>
              <Link className="button button-secondary" to="/blood-bank/inventory">
                Inventory
              </Link>
              <Link className="button button-primary" to="/blood-bank/city-requests">
                City requests
              </Link>
            </>
          }
      ...
      <section className="content-card">
        ...
        <div className="grid-form" style={{ gridTemplateColumns: "repeat(auto-fill, minmax(140px, 1fr))" }}>
          <Link className="button button-secondary" to="/blood-bank/inventory"><Warehouse size={14} /> Inventory</Link>
          <Link className="button button-secondary" to="/blood-bank/city-requests"><ClipboardList size={14} /> City requests</Link>
          <Link className="button button-secondary" to="/blood-bank/drives"><Megaphone size={14} /> Drives</Link>
          <Link className="button button-secondary" to="/blood-bank/appointments"><Calendar size={14} /> Appointments</Link>
          <Link className="button button-secondary" to="/blood-bank/analytics"><BarChart3 size={14} /> Analytics</Link>
          <Link className="button button-secondary" to="/blood-bank/profile"><Settings size={14} /> Profile</Link>
        </div>
      </section>
    </div>
  );
